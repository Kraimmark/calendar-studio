...
export function App() {
  ...
  return <CalendarScreen theme={theme} repository={repository} portability={portability} workspace={workspace} onToggleTheme={() => setTheme((current) => (current === 'dark' ? 'light' : 'dark'))} />;
}
